...
- Резервное управление через Telegram-бота (aiogram 3): бот показывает примерное время до нагрева; доступ только у админов из конфига (`ADMIN_ID`); возможность работы через прокси для обхода блокировок
